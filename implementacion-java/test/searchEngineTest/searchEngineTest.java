...
public class searchEngineTest {
	...
	App system = new App();
	User mariano = new User("mariano789", system);
	User sergio = new PermanentE("sergioCASLA", system);
	User andrea = new PermanentE("andreaCAI", system);
	...
	public void setUp() {
		...
		Sample votada = system.getSamplesTotal().get(0);
		...
		Sample verificada = system.getSamplesTotal().get(1); 
		...
		mariano.uploadSample(EVinchuca.Sordida, pos);
		Sample votada2 = system.getSamplesTotal().get(2);
		...
		mariano.uploadSample(EVinchuca.Infestans, pos);
		Sample votada3 = system.getSamplesTotal().get(3);
		...
		mariano.uploadSample(EVinchuca.Infestans, pos);
		Sample verificada2 = system.getSamplesTotal().get(4); 
	...
	public void buscarCaso1() {
		...
		List<Sample> results = serEng.buscar(system.getSamplesTotal(), criterios, logOps);
